...
const ioport_pin_cfg_t g_bsp_pin_cfg_data[] = {
    ...
    },
    {
        ...
        .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P184_PFC_02_TXD4_SDA4_MOSI4)
    },
    {
        .pin = BSP_IO_PORT_18_PIN_5,
        .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P185_PFC_02_RXD4_SCL4_MISO4)
    },
    {
