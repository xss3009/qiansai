...
// 添加过滤模式变量
static const char *filter_extension = ".txt"; // 只显示.txt文件
static bool filter_files_only = false;
...
/* 添加新的API函数来设置过滤模式 */
void lv_fs_fatfs_set_filter(bool files_only)
{
    filter_files_only = files_only;
}
