/* generated vector source file - do not edit */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_MAX_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [33] = ether_eint_isr, /* EDMAC0 EINT (EDMAC 0 interrupt) */
            [34] = ssi_rxi_isr, /* SSI0 RXI (Receive data full) */
            [35] = ssi_int_isr, /* SSI0 INT (Error interrupt) */
            [36] = sci_uart_rxi_isr, /* SCI4 RXI (Received data full) */
            [37] = sci_uart_txi_isr, /* SCI4 TXI (Transmit data empty) */
            [38] = sci_uart_tei_isr, /* SCI4 TEI (Transmit end) */
            [39] = sci_uart_eri_isr, /* SCI4 ERI (Receive error) */
        };
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_MAX_ENTRIES] =
        {
            ...
            [33] = BSP_PRV_IELS_ENUM(EVENT_EDMAC0_EINT), /* EDMAC0 EINT (EDMAC 0 interrupt) */
            [34] = BSP_PRV_IELS_ENUM(EVENT_SSI0_RXI), /* SSI0 RXI (Receive data full) */
            [35] = BSP_PRV_IELS_ENUM(EVENT_SSI0_INT), /* SSI0 INT (Error interrupt) */
            [36] = BSP_PRV_IELS_ENUM(EVENT_SCI4_RXI), /* SCI4 RXI (Received data full) */
            [37] = BSP_PRV_IELS_ENUM(EVENT_SCI4_TXI), /* SCI4 TXI (Transmit data empty) */
            [38] = BSP_PRV_IELS_ENUM(EVENT_SCI4_TEI), /* SCI4 TEI (Transmit end) */
            [39] = BSP_PRV_IELS_ENUM(EVENT_SCI4_ERI), /* SCI4 ERI (Receive error) */
        };
        #endif