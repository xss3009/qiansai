/* generated vector header file - do not edit */
        ...
        #define VECTOR_NUMBER_EDMAC0_EINT ((IRQn_Type) 33) /* EDMAC0 EINT (EDMAC 0 interrupt) */
        #define EDMAC0_EINT_IRQn          ((IRQn_Type) 33) /* EDMAC0 EINT (EDMAC 0 interrupt) */
        #define VECTOR_NUMBER_SSI0_RXI ((IRQn_Type) 34) /* SSI0 RXI (Receive data full) */
        #define SSI0_RXI_IRQn          ((IRQn_Type) 34) /* SSI0 RXI (Receive data full) */
        #define VECTOR_NUMBER_SSI0_INT ((IRQn_Type) 35) /* SSI0 INT (Error interrupt) */
        #define SSI0_INT_IRQn          ((IRQn_Type) 35) /* SSI0 INT (Error interrupt) */
        #define VECTOR_NUMBER_SCI4_RXI ((IRQn_Type) 36) /* SCI4 RXI (Received data full) */
        #define SCI4_RXI_IRQn          ((IRQn_Type) 36) /* SCI4 RXI (Received data full) */
        #define VECTOR_NUMBER_SCI4_TXI ((IRQn_Type) 37) /* SCI4 TXI (Transmit data empty) */
        #define SCI4_TXI_IRQn          ((IRQn_Type) 37) /* SCI4 TXI (Transmit data empty) */
        #define VECTOR_NUMBER_SCI4_TEI ((IRQn_Type) 38) /* SCI4 TEI (Transmit end) */
        #define SCI4_TEI_IRQn          ((IRQn_Type) 38) /* SCI4 TEI (Transmit end) */
        #define VECTOR_NUMBER_SCI4_ERI ((IRQn_Type) 39) /* SCI4 ERI (Receive error) */
        #define SCI4_ERI_IRQn          ((IRQn_Type) 39) /* SCI4 ERI (Receive error) */
        #endif /* VECTOR_DATA_H */